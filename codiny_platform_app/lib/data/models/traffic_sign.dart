  ...
  static List<TrafficSign> getAllSigns() {
    return [
      ...
      TrafficSign(
        id: '9',
        name: 'Animals',
        arabicName: 'احذر الحيوانات',
        imagePath: 'assets/traffic_signs/Donkey.png',
        category: 'warning',
        description: 'احذر - عبور حيوانات',
      ),
      TrafficSign(
        id: '10',
        name: 'Zigzag Road',
      ...
      TrafficSign(
        ...
        imagePath: 'assets/traffic_signs/NoTruck.svg',
        category: 'prohibition',
      ...
      TrafficSign(
        id: '23',
        name: 'Must Stop',
        arabicName: 'توقف إجباري',
        imagePath: 'assets/traffic_signs/Stop.svg',
        category: 'mandatory',
