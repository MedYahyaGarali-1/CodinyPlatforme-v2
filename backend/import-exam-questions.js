...
async function importQuestions() {
  try {
    ...
    for (let i = 0; i < questions.length; i++) {
      ...
      // Handle questions with 2 or 3 options
      const optionA = q.opts[0] || '';
      const optionB = q.opts[1] || '';
      const optionC = q.opts[2] || 'N/A';  // Default value for 2-option questions
      ...
      `, [
        ...
        optionA,                  // option_a
        optionB,                  // option_b
        optionC,                  // option_c (N/A for 2-option questions)
